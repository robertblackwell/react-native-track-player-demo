...
console.log(["ZZZ App.js", TrackPlayer])
...
export default class App extends Component {
	...
	onPressAdd4Tracks() {
		let self = this
		console.log(["App::onPressLoad4Tracks",""])
		...
		.then(()=>{
			...
			TrackPlayer.getCurrentTrack().then( (id) => {
				console.log(["App::onPressLoad4Tracks",`add.then id: {id}`])
	...
	onPressSeekPlus10() {
		...
		let new_cp = cp + 10.0
		console.log(["App::seek+10",`current position is : ${this.state.track_position}`])
		// TrackPlayer.seekTo(new_cp)
		TrackPlayer.seekToPromise(new_cp)
		.then(()=>{
			console.log(["App::seek+10"," then"])
		})
		.catch(()=>{
			console.log(["App::seek+10","catch"])
		})
	...
	onPressSeekTo70() {
		let cp = this.state.track_position;
		let new_cp = 70.0
		console.log(["App::seek to 70",`current position is : ${this.state.track_position}`])
		// TrackPlayer.seekTo(new_cp)
		TrackPlayer.seekToPromise(new_cp)
		.then(()=>{
			console.log(["App::seek to 70"," then"])
		})
		.catch(()=>{
			console.log(["App::seek to 70","catch"])
		})
	}
	...
	render() {
		// @todo need to postpone these calls until some tracks arer loaded
